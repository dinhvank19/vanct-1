<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ProductGroupList.aspx.cs" Inherits="POS.WebApp.Admin.ProductGroupList" %>
                ...
                <div style="margin-left: 10px; border: 1px solid #ccc; padding: 10px; width: 420px;">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><telerik:RadTextBox ID="txtDescription" runat="server" Width="300" TextMode="MultiLine" Height="80" /></td>
                        </tr>
                        <tr>
