<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="POS.WebApp.Admin.UserList" %>
            ...
            <telerik:RadGrid AutoGenerateColumns="False" ID="grid" runat="server"
                ...
                <MasterTableView DataKeyNames="Id">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Tài khoản" DataField="Username" SortExpression="Username" />
                ...
                <div style="margin-left: 10px; border: 1px solid #ccc; padding: 10px; width: 420px;">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><telerik:RadTextBox ID="txtUsername" runat="server" Width="300" /></td>
                        </tr>
                        <tr>
                            <td style="text-align: right">Mật khẩu</td>
                            <td><telerik:RadTextBox ID="txtPassword" runat="server" Width="300" TextMode="Password" /></td>
                        </tr>
                        <tr>
