(function (f) {
        ...
        this._intervalId = setInterval(function () {
            L._$stripes.eq(N)
                .animate({
                    ...
                    opacity: 1,
                    width: L._size
                }, L._rotator._duration, L._rotator._easing, function () {
                    if (f(this)
                    .attr("id") == I) {
    ...
    p.prototype.init = function () {
        ...
        for (var J = 0; J < this._numRows; J++) {
            ...
            for (var I = 0; I < this._numCols; I++) {
                this._$blockArr[J][I] = this._$blocks.filter("#" + (J + "-" + I))
                    .data("top", J * this._size)
            }
        }
    };
    ...
    p.prototype.diagAnimate = function (H, Q, M) {
        ...
        var N = this;
        this._intervalId = setInterval(function () {
            P[O++].animate(Q, N._rotator._duration, N._rotator._easing, function () {
                if (f(this)
                    .attr("id") == K) {
    ...
    p.prototype.zigZag = function (I, P) {
        ...
        this._intervalId = setInterval(function () {
            O._$blockArr[N][L].animate({
                opacity: 1
            }, O._duration, O._rotator._easing, function () {
                if (f(this)
                    .attr("id") == K) {
    ...
    p.prototype.spiral = function (H, P) {
        ...
        if (S.length > 0) {
            ...
            this._intervalId = setInterval(function () {
                S[K].animate({
                    opacity: 1
                }, Q._rotator._duration, Q._rotator._easing, function () {
                    if (f(this)
                        .attr("id") == I) {
    ...
    function D(I, H) {
        this._screenWidth = d(H.width, 825);
        this._screenHeight = d(H.height, 300);
    ...
    D.prototype.init = function () {
        this._$cloneDom = this._$obj.find(">div:first")
            .clone();
    ...
    D.prototype.initButtons = function () {
        ...
        var I = this._$buttonPanel.find(">div")
            .css({
        ...
        if (this._cpVertical) {
            ...
            if (B) {
                this._$buttonPanel.height(this._$buttonPanel.find(">div:visible")
                    .size() * I.outerHeight(true))
            }
            ...
            if (B) {
                this._$buttonPanel.width(this._$buttonPanel.find(">div:visible")
                    .size() * I.outerWidth(true))
            }
    ...
    D.prototype.initTimerBar = function () {
        this._$timer = this._$screen.find(".timer")
            .data("pct", 1);
        ...
        if (this._displayThumbs) {
                ...
                for (var N = 0; N < J; N++) {
                    ...
                    if (I[0].complete || I[0].readyState == "complete") {
                        ...
                        I.load(function () {
                            f(this)
                                .css({
                                    top: (R._thumbHeight - f(this)
                                    .height()) / 2,
                                    left: (R._thumbWidth - f(this)
                                    .width()) / 2
                                })
                        })
                    }
            ...
            if (this._cpVertical) {
                ...
                if (this._$thumbPanel.height() > V) {
                    ...
                    this._$list.addClass("inside")
                        .height(this._numItems * H);
                    ...
                    this._$rotator.bind(x, function () {
                        if (!R._$list.is(":animated")) {
                            var Y = R._$list.position()
                                .top + (R._currIndex * H);
                            ...
                            if (Y < 0 || Y > R._$thumbPanel.width() - R._$thumbs.outerWidth()) {
                                ...
                                R._$list.stop(true)
                                    .animate({
                                        ...
                                        f(this)
                                        .position()
                                        .left == 0 ? W.hide() : W.show();
                                        f(this)
                                        .position()
                                        .left == O ? S.hide() : S.show()
                                    })
                            }
                        }
                    })
    ...
    D.prototype.initTooltip = function () {
        if (this._tipType == "text") {
            f("body")
                .append("<div id='rotator-tooltip'><div class='tt-txt'></div></div>");
            this._$tooltip = f("body")
                .find("#rotator-tooltip");
            this._$thumbs.bind("mouseover", {
                elem: this
            }, this.showTooltip)
                .bind("mouseout", {
            ...
            switch (m[this._cpAlign]) {
                ...
                case m.TC:
                case m.TR:
                    this._$tooltip.data("bottom", true)
                    .addClass("txt-down");
                    break;
                default:
                    this._$tooltip.data("bottom", false)
                    .addClass("txt-up")
            }
        } else {
            if (this._tipType == "image") {
                ...
                switch (m[this._cpAlign]) {
                    ...
                    case m.LB:
                        ...
                        this._$tooltip.data("right", true)
                        .addClass("img-right");
                        break;
                    case m.RT:
                    case m.RC:
                    case m.RB:
                        ...
                        this._$tooltip.data("right", false)
                        .addClass("img-left");
                        break;
                    default:
                        this._$thumbs.bind("mouseover", {
        ...
        if (a(6)) {
            try {
                this._$tooltip.css("background-image", "none")
                    .children()
                    .css("margin", 0)
            } catch (H) { }
        }
    ...
    D.prototype.showHImgTooltip = function (J) {
        var I = J.data.elem;
        var H = I._$tooltip.find(">img")
            .eq(f(this)
            .index());
        if (H.attr("src")) {
            I._$tooltip.find(">img")
                .hide();
            H.show();
            if (H[0].complete || H[0].readyState == "complete") {
                var L = I._$tooltip.data("bottom") ? f(this)
                    .outerHeight() : -I._$tooltip.outerHeight();
                var K = f(this)
                    .offset();
                I._$tooltip.css({
                    top: K.top + L,
                    left: K.left + ((f(this)
                        .outerWidth() - I._$tooltip.outerWidth()) / 2)
                })
                    .stop(true, true)
                    .delay(r)
                    .fadeIn(300)
    ...
    D.prototype.showVImgTooltip = function (K) {
        var J = K.data.elem;
        var H = J._$tooltip.find(">img")
            .eq(f(this)
            .index());
        if (H.attr("src")) {
            J._$tooltip.find(">img")
                .hide();
            H.show();
            if (H[0].complete || H[0].readyState == "complete") {
                var I = J._$tooltip.data("right") ? f(this)
                    .outerWidth() : -J._$tooltip.outerWidth();
                var L = f(this)
                    .offset();
                J._$tooltip.css({
                    top: L.top + ((f(this)
                        .outerHeight() - J._$tooltip.outerHeight()) / 2),
                    left: L.left + I
                })
                    .stop(true, true)
                    .delay(r)
    ...
    D.prototype.showTooltip = function (J) {
        var I = J.data.elem;
        var H = I._$items[f(this)
            .index()].data("caption");
        if (H != "") {
            I._$tooltip.find(">div.tt-txt")
                .html(H);
    ...
    D.prototype.resetText = function () {
        this._$textBox.data("visible", false)
            .stop(true, true);
        switch (C[this._textEffect]) {
            ...
            case C.up:
                ...
                this._$textBox.fadeOut(y, function () {
                    f(this)
                    .css("display", "none")
                });
                break;
    ...
    D.prototype.expandText = function (L, K, J, H) {
        var I = this;
        this._$innerText.css("opacity", 1)
            .html("");
        this._$textBox.stop(true, true)
            .css({
                display: "block",
                top: K.y,
                left: K.x,
    ...
    D.prototype.loadContent = function (J) {
        ...
        this._$thumbs.filter(".curr-thumb")
            .removeClass("curr-thumb");
        this._$thumbs.eq(J)
            .addClass("curr-thumb");
        ...
        if (this._$mainLink) {
            ...
            var H = L.attr("href");
            if (H) {
                this._$mainLink.unbind("click", q)
                    .css("cursor", "pointer")
                    .attr({
                        href: H,
    ...
    D.prototype.setPrevious = function () {
        if (this._prevIndex >= 0) {
            var I = this._$mainLink.find("img#curr-img")
                .attr("src");
            var J = this._$items[this._prevIndex].data("imgurl");
            if (I != J) {
                this._$mainLink.find("img.main-img")
                    .attr("id", "")
                    .hide();
                var H = this._$mainLink.find("img.main-img")
                    .filter(function () {
                        return f(this)
                        .attr("src") == J
                    });
    ...
    D.prototype.fadeInContent = function (H) {
        var I = this;
        this._$mainLink.find("img#curr-img")
            .stop(true, true);
        this._$mainLink.find("img.main-img")
            .attr("id", "")
            .css("z-index", 0);
        H.attr("id", "curr-img")
            ...
            .animate({
                ...
                I._$mainLink.find("img.main-img:not('#curr-img')")
                .hide();
                if (I._textSync) {
    ...
    D.prototype.slideContent = function (M, O, L) {
        ...
        if (H.size() > 0) {
            ...
            var K = this;
            this._$strip.stop(true, true)
                .animate(N, this._duration, this._easing, function () {
                    K._$strip.find(".main-img:not('#curr-img')")
                    .parents(".content-box")
                    .hide();
                    K._$strip.find("#curr-img")
                    .parents(".content-box")
                    .show();
                    J.parents(".content-box")
                    .css({
    ...
    D.prototype.storeImg = function (J, K) {
        if (this._globalEffect == "h.slide" || this._globalEffect == "v.slide") {
            ...
            this.centerImg(K);
            var H = f("<div class='content-box'></div>")
                .css({
                    width: this._screenWidth,
                    height: this._screenHeight
                });
