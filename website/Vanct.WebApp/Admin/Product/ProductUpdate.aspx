<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ProductUpdate.aspx.cs" Inherits="Vanct.WebApp.Admin.Product.ProductUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadButton ID="RadButton4" runat="server" Text="Xem sản phẩm" OnClick="BtnBackClick" />
    <telerik:RadButton ID="RadButton5" runat="server" Text="Tạo mới" OnClick="BtnCreateClick" />
    ...
    <table>
        ...
        <tr>
            <td style="vertical-align: top;">Hình đại diên <span class="_important">(*)</span></td>
        ...
        <tr style="display: none;">
            <td>Bảo hành</td>
            <td><telerik:RadTextBox ID="txtWarranty" runat="server" Width="300" /></td>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tr>
            <td>Hoạt động</td>
            <td><asp:CheckBox ID="ckIsActive" runat="server" Checked="False" /></td>
    ...
    <telerik:RadButton ID="RadButton3" runat="server" Text="Tạo mới" OnClick="BtnCreateClick" />
</asp:Content>
