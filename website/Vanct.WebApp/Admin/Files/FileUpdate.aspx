<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="FileUpdate.aspx.cs" Inherits="Vanct.WebApp.Admin.Files.FileUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadButton ID="btnCreate" runat="server" Text="Tạo mới" OnClick="BtnCreateClick" />
    <asp:Label runat="server" ID="lblMessage" ForeColor="red" />
    <table>
        <tr>
            <td>Tên hiển thị</td>
            <td><telerik:RadTextBox ID="txtName" runat="server" Width="400"/></td>
            <td>File đã upload: <asp:HyperLink runat="server" ID="oldFile"/></td>
        </tr>
        <tr>
